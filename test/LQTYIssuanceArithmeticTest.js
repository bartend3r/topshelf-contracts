...
contract('LQTY community issuance arithmetic tests', async accounts => {
  ...
  beforeEach(async () => {
    ...
    contracts.stabilityPool = await StabilityPool.new("200000000000000000000")
  ...
  it.skip("Frequent token issuance: issuance event every year, for 30 years", async () => {
    ...
    await borrowerOperations.openTrove(alice, th._100pct, dec(1, 18), alice, alice, { from: alice, value: dec(1, 'ether') })
